...
def single_corner(analyze_single, name='corner.png', save=False, theta=True):
    '''
...
def single_comparison(analyze_single, input_data_path, name='comparison.png', save=False):
    '''
    ...
    for band in bands: 
        ...
        for i in range(1, num_realizations+1):
            ...
            plt.plot(time, mag, '-', color=bandcolor(band))
...
def money_plot(analyze_set, name='money.png', theta=True, save=False, truevtrue=True):
    '''
